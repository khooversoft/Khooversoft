...
{
    [EventSource(Name = "Vault.Client")]
    public class VaultClientEventSource : EventSource, IEventLog
    {
        public static VaultClientEventSource Log { get; } = new VaultClientEventSource();
