...
{
    public class TestClientConfiguration : IVaultClientConfiguration
    {
        ...
        public TokenKey TokenKey { get; } = new TokenKey("testAuthority.Issuer@domain.com", "testClient.issuer@domain.com");
